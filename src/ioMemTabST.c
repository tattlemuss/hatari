...
const char IoMemTabST_fileid[] = "Hatari ioMemTabST.c";
...
const INTERCEPT_ACCESS_FUNC IoMemTable_ST[] =
{
	...
	{ 0xff8260, SIZE_BYTE, Video_ResGlueShifter_ReadByte, Video_ResGlueShifter_WriteByte },	/* Resolution in GLUE/Shifter */
	{ 0xff8261, SIZE_BYTE, Video_ResShifter_ReadByte, Video_ResShifter_WriteByte },		/* Resolution in Shifter only */
	{ 0xff8262, 30,        IoMem_VoidRead, IoMem_VoidWrite },                               /* No bus errors here */
